...
const DATOS_REALES: Record<string, { casos: number; nota: string; tipo: "baja" | "rebote" | "normal" }> = {
  Enero:      { casos: 2465,  nota: "Inicio del año con ritmo normal.",                                         tipo: "normal" },
  Febrero:    { casos: 1710,  nota: "Mes corto, volumen estable previo a la pandemia.",                         tipo: "normal" },
  Marzo:      { casos: 995,   nota: "El 16 de marzo se declaró el Estado de Excepción (Decreto 1017). Al día siguiente se suspendieron todas las labores judiciales y notariales.", tipo: "baja" },
  ...
  Junio:      { casos: 491,   nota: "Inicio de reactivación progresiva del sistema judicial.",                  tipo: "normal" },
  Julio:      { casos: 1406,  nota: "Recuperación parcial conforme se habilitan más juzgados.",                 tipo: "normal" },
  Agosto:     { casos: 1383,  nota: "Aceleración visible a medida que se procesan casos represados.",           tipo: "normal" },
  Septiembre: { casos: 1723,  nota: "Máximo del año: absorbe el rezago acumulado durante el confinamiento. El sistema judicial procesa las solicitudes que no pudieron tramitarse entre abril y junio.", tipo: "rebote" },
  Octubre:    { casos: 1402,  nota: "Volumen alto, todavía por encima del promedio normal.",                    tipo: "normal" },
  Noviembre:  { casos: 1429,  nota: "Descenso gradual conforme se depura el rezago acumulado.",                 tipo: "normal" },
  Diciembre:  { casos: 1545,  nota: "Fin de año con ritmo normalizado.",                                        tipo: "normal" },
};
...
const INDEX_INSIGHTS = {
  ...
  details: {
    Marzo: {
      label: "Marzo (995 casos)",
      interpretiveText:
        "El 16 de marzo se declaró el Estado de Excepción (Decreto 1017). Al día siguiente se suspendieron todas las labores judiciales — de 2.465 casos en enero a 995 en marzo, la caída es inmediata.",
    },
    Abril: {
      label: "Abril (1 caso)",
    ...
    Junio: {
      label: "Junio (491 casos)",
      interpretiveText: "Junio marca la reactivación progresiva previa a la reapertura total del sistema judicial.",
    },
    Septiembre: {
      label: "Septiembre (1.723 casos)",
      interpretiveText: "Máximo del año. Absorbe los trámites represados entre abril y junio: 1.723 divorcios en un solo mes, demostrando un rebote post-confinamiento.",
    },
    Guayas: {
      label: "Guayas",
