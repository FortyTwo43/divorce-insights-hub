        ...
        <div className="flex flex-wrap items-center gap-2">
          {selectedProvince && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/30">
              ...
              {selectedProvince}
              <button onClick={() => setSelectedProvince(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de provincia">
          ...
          {selectedCanton && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/30">
              ...
              {selectedCanton}
              <button onClick={() => setSelectedCanton(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de cantón">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedMonth && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-accent/10 text-accent border border-accent/30">
              ...
              {selectedMonth}
              <button onClick={() => setSelectedMonth(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de mes">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedCause && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-yellow-500/10 text-yellow-600 border border-yellow-500/30">
              ...
              <button onClick={() => setSelectedCause(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de causa">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedDuration && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-orange-500/10 text-orange-600 border border-orange-500/30">
              ...
              <button onClick={() => setSelectedDuration(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de duración">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedAge && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-green-500/10 text-green-600 border border-green-500/30">
              ...
              {selectedAge} años
              <button onClick={() => setSelectedAge(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de edad">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedEdu && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-600 border border-blue-500/30">
              ...
              {selectedEdu}
              <button onClick={() => setSelectedEdu(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de educación">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedEthnicity && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-purple-500/10 text-purple-600 border border-purple-500/30">
              ...
              {selectedEthnicity}
              <button onClick={() => setSelectedEthnicity(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de etnia">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
          {selectedChildren && (
            <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-full bg-pink-500/10 text-pink-600 border border-pink-500/30">
              ...
              <button onClick={() => setSelectedChildren(null)} className="ml-1 -mr-0.5 p-1 rounded-full hover:bg-destructive/15 hover:text-destructive transition-colors" aria-label="Quitar filtro de hijos">
                <svg className="w-3 h-3" viewBox="0 0 20 20" fill="currentColor"><path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" /></svg>
              </button>
            </span>
          )}
